...
function sendInvokeResponse(context, body = null, status = botframework_schema_1.StatusCodes.OK) {
    return __awaiter(this, void 0, void 0, function* () {
        yield context.sendActivity({
            type: botframework_schema_1.ActivityTypes.InvokeResponse,
            value: { body, status },
        });
    });
}
...
class TeamsSSOTokenExchangeMiddleware {
    ...
    onTurn(context, next) {
        return __awaiter(this, void 0, void 0, function* () {
            if (context.activity.channelId === botframework_schema_1.Channels.Msteams && context.activity.name === botbuilder_core_1.tokenExchangeOperationName) {
    ...
    exchangedToken(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!tokenExchangeResponse.token) {
                ...
                yield sendInvokeResponse(context, invokeResponse, botframework_schema_1.StatusCodes.PRECONDITION_FAILED);
                return false;
            }
            return true;
        });
